...
> ⚠️ **COMASAT în `core:articles` (2026-07-24).** Acest skill rămâne funcțional dar e înlocuit de **`core:articles --store nubra`** (un pipeline pt toate magazinele de parfum). Prefer `core:articles`. `shared/skills-audit.md` §7.
