...
NB: **Gento NU e sărit** — vinde genți unde diferă culorile/modelele → poza chiar ajută. Deals/casă (Grandia,
Carpetto, Covoria, Casa Ofertelor…) = mereu rezolvate. Câmpul `source`=`skip` în registru pentru cele sărite.
